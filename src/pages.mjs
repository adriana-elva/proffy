import {conectdb} from './database/db.mjs'
import {subjects,weekdays,getSubject,convertHoursToMinutes} from './utils/format.mjs'

import {createProffy} from './database/createProffy.mjs'
